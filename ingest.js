...
if (argv.length === 0) {
  ...
  console.log('  node ingest.js --file ncert_math10.pdf --board CBSE --subject Mathematics --grade 10 --lang en')
  console.log('  node ingest.js --subject mathematics --grade 10 --lang en  # runs NCERT scraper')
  console.log('  node ingest.js --retry-failed --run-id <ingestRunId>   # retry failed chunks from run')
  process.exit(0)
}
