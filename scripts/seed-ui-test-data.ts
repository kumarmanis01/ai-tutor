...
export async function seed() {
  ...
  try {
    ...
    console.warn(
      'studentLearningProfile.upsert failed, attempting tolerant fallback:',
      err?.message || err
    );
    ...
    try {
      ...
      console.warn(
        'Fallback create/update also failed for studentLearningProfile:',
        err2?.message || err2
      );
    }
  }
