    ...
    easy: [
      {
        ...
        options: [
          'A core CBSE Grade 10 concept',
          'An advanced college topic',
          'Outside the syllabus',
          'Unrelated',
        ],
        answer: 'A core CBSE Grade 10 concept',
        explanation: `${topicName} is fundamental to the curriculum.`,
        marks: 1,
      },
      {
        type: 'short_answer',
        question: `Define ${topicName} in two sentences.`,
        options: null,
        answer: 'State the core idea and its scope.',
        explanation: 'A good definition is precise and contextual.',
        marks: 2,
      },
    ],
    medium: [
      {
        type: 'mcq',
        question: `Which principle applies directly to ${topicName}?`,
        options: [
          'The primary principle of this topic',
          "Newton's 3rd law",
          "Archimedes' principle",
          "Boyle's law",
        ],
        answer: 'The primary principle of this topic',
        explanation: `The core rule of ${topicName} governs this scenario.`,
        marks: 2,
      },
      {
        type: 'short_answer',
        question: `Explain with an example how ${topicName} is applied.`,
        options: null,
        answer: `Apply the concept of ${topicName} with a worked example.`,
        explanation: 'Application questions test deeper understanding.',
        marks: 3,
      },
    ],
    hard: [
      {
        type: 'mcq',
        question: `In a complex scenario involving ${topicName}, changing initial conditions leads to:`,
        options: [
        ...
        explanation: `Proportional reasoning is central to ${topicName}.`,
        marks: 3,
      },
      {
        type: 'short_answer',
        question: `Compare two approaches for solving problems in ${topicName}. Which is more efficient?`,
        options: null,
        answer: 'Analyse trade-offs: accuracy, speed, and applicability.',
        explanation: 'Higher-order questions require evaluation skills.',
        marks: 4,
      },
    ],
  };
              ...
              [
                {
                  ...
                  explanation:
                    'Triggered by the Jallianwala Bagh massacre (1919) and Khilafat grievances, Gandhi proposed non-cooperation at the Nagpur session of the INC (December 1920). Indians surrendered titles, boycotted civil services, army, courts, and government schools.',
                  keyTakeaway:
                    'Non-cooperation = withdrawal from all British institutions + swadeshi.',
                },
                {
                  heading: 'Spread and Withdrawal',
                  explanation:
                    'The movement spread to towns and villages. It was called off after Chauri Chaura (February 1922) where a crowd burned a police station. Gandhi believed satyagrahis were not ready for mass civil disobedience.',
                  keyTakeaway:
                    'Chauri Chaura incident → suspension of movement; satyagraha must remain non-violent.',
                },
              ],
              [
                {
                  term: 'Satyagraha',
                  definition: 'Truth-force; resistance through non-violent means.',
                  example: 'Gandhi used satyagraha in South Africa before India.',
                },
                {
                  term: 'Khilafat Issue',
                  definition: "Muslims' concern over the Ottoman Caliph after WWI.",
                  example: 'Congress supported the Khilafat Committee in 1919.',
                },
              ],
              [
                {
                  scenario: 'Students boycotting government schools during Non-Cooperation.',
                  connection:
                    'This showed ordinary people could challenge colonial authority at scale.',
                },
              ]
            ),
          },
              ...
              [
                {
                  ...
                  explanation:
                    'On 12 March 1930 Gandhi left Sabarmati Ashram reaching Dandi on 6 April to make salt illegally. People across India broke the salt law, boycotted foreign cloth and liquor. Women participated in large numbers for the first time.',
                  keyTakeaway:
                    'Dandi March → salt as symbol of colonial exploitation → mass civil disobedience.',
                },
                {
                  heading: 'Gandhi-Irwin Pact and Aftermath',
                  explanation:
                    'In March 1931 Gandhi signed the Gandhi-Irwin Pact: release of political prisoners and permission for salt collection on the coast. Congress agreed to attend the Round Table Conference. The second conference (London, 1931) failed; CDM resumed 1932 and was formally withdrawn 1934.',
                  keyTakeaway:
                    'Gandhi-Irwin Pact = temporary truce; movement resumed 1932, withdrawn 1934.',
                },
              ],
              [
                {
                  term: 'Civil Disobedience',
                  definition: 'Deliberate, non-violent refusal to obey specific unjust laws.',
                  example:
                    'Breaking the salt law was a direct challenge to a specific colonial regulation.',
                },
                {
                  term: 'Dandi March',
                  definition:
                    '240-mile march to the sea led by Gandhi in March-April 1930 to protest the salt tax.',
                  example: 'The march lasted 24 days and triggered nationwide satyagraha.',
                },
              ],
              [
                {
                  scenario: 'Comparing Non-Cooperation (1920) and Civil Disobedience (1930).',
                  connection:
                    'CDM directly broke specific laws (salt tax); NCM focused on withdrawal. CDM had greater mass participation.',
                },
              ]
            ),
          },
              ...
              [
                {
                  ...
                  explanation:
                    'By origin: biotic (living, e.g. forests, fish) and abiotic (non-living, e.g. rocks, metals). By exhaustibility: renewable (replenishable, e.g. solar, water) and non-renewable (finite, e.g. coal, petroleum).',
                  keyTakeaway:
                    'Renewable ↔ replenishable; Non-renewable ↔ exhaustible over geological time.',
                },
                {
                  heading: 'Ownership and Development Status',
                  explanation:
                    'By ownership: individual, community, national, international. By development status: potential, developed, stock, reserves.',
                  keyTakeaway:
                    '4 ownership types × 4 development-status types = classification matrix.',
                },
              ],
              [
                {
                  term: 'Biotic Resources',
                  definition: 'Resources from the biosphere (living component).',
                  example: 'Forests, animals, fish, birds.',
                },
                {
                  term: 'Non-renewable Resources',
                  definition: 'Resources that cannot be replenished once used.',
                  example: 'Coal, petroleum, natural gas.',
                },
              ],
              [
                {
                  scenario: "India's coal reserves are depleting rapidly due to industrial use.",
                  connection:
                    'Coal is a non-renewable abiotic national resource -- once exhausted it cannot be renewed, driving the shift to solar/wind.',
                },
              ]
            ),
          },
          {
            ...
            note: buildNote(
              ...
              [
                {
                  ...
                  explanation:
                    'The seven categories: (1) Forests, (2) Land not available for cultivation, (3) Other uncultivated land, (4) Fallow lands, (5) Net sown area. Forest area in India (≈23%) is below the National Forest Policy target of 33%.',
                  keyTakeaway:
                    'Net sown area + fallow = gross cropped area. Forests cover ~23% vs 33% target.',
                },
                {
                  heading: 'Factors and Conservation',
                  explanation:
                    'Physical factors: topography, climate, soil. Human factors: population, technology. Degradation: erosion, waterlogging, salinisation, desertification. Conservation: crop rotation, contour ploughing, terrace farming.',
              ...
              [
                {
                  term: 'Net Sown Area',
                  definition: 'Land sown with crops at least once in a year.',
                  example: 'Punjab has the highest net sown area as % of total area.',
                },
                {
                  term: 'Fallow Land',
                  definition: 'Cultivable land left uncultivated to restore fertility.',
                  example: 'Current fallow: left uncultivated in the current year.',
                },
              ],
              [
                {
                  scenario: 'Farmer leaves land uncultivated every third year.',
                  connection:
                    'This is fallow land practice -- it restores soil nutrients naturally.',
                },
              ]
            ),
          },
        ...
        topics: [
          {
            ...
            note: buildNote(
              ...
              [
                {
                  ...
                  explanation:
                    "Lencho's crops are destroyed by a hailstorm. He writes to God asking for 100 pesos. The postmaster, moved by his faith, collects 70 pesos from staff and sends it anonymously. Lencho, receiving only 70 pesos, writes again accusing post office employees of stealing the rest.",
                  keyTakeaway:
                    'Lencho = blind faith; Post office = human kindness; Irony = helpers accused of theft.',
                },
                {
                  heading: 'Themes and Literary Devices',
                  explanation:
                    'Themes: unwavering faith, irony of human kindness going unrecognised. Literary devices: personification (rain like locusts), metaphor, irony. The story questions whether blind faith ignores human goodness.',
              ...
              [
                {
                  term: 'Irony',
                  definition: 'A literary device where the outcome is contrary to expectation.',
                  example: 'Lencho accuses the kind helpers of being thieves.',
                },
                {
                  term: 'Personification',
                  definition: 'Giving human qualities to non-human things.',
                  example: '"The rain was like new coins" -- comparing rain to money.',
                },
              ],
              [
                {
                  scenario: 'Lencho receives 70 pesos instead of 100.',
                  connection:
                    "He interprets the shortage as theft, never considering the post office employees donated their own money -- the story's tragic irony.",
                },
              ]
            ),
          },
              ...
              [
                {
                  ...
                  explanation:
                    'The ceremony was held at the Union Buildings, Pretoria. Military generals who had previously jailed Mandela now saluted him -- a victory for justice. He saw the transformation of the apartheid state into one that recognised the rights of all.',
                  keyTakeaway:
                    'Inauguration = triumph of justice; former oppressors saluted Mandela.',
                },
                {
                  heading: 'Meaning of Freedom and Courage',
                  explanation:
                    'Mandela distinguishes two obligations: to family and to people/community. The oppressor is also a prisoner of hatred. True freedom = freedom of all. Courage = triumph over fear, not its absence.',
                  keyTakeaway:
                    'Freedom = freedom of all; Courage = triumph over fear, not its absence.',
                },
              ],
              [
                {
                  term: 'Apartheid',
                  definition: 'Institutionalised racial segregation in South Africa, 1948-1994.',
                  example:
                    'Black South Africans were denied voting rights and freedom of movement.',
                },
                {
                  term: 'Inauguration',
                  definition: 'Formal ceremony inducting a person into a position of authority.',
                  example: "Mandela's inauguration on 10 May 1994 marked the end of apartheid.",
                },
              ],
              [
                {
                  scenario: "Mandela's reflection on generals who jailed him now saluting him.",
                  connection:
                    'Symbolises the complete transformation of South Africa -- the oppressor system bowing to human dignity.',
                },
              ]
            ),
          },
              ...
              [
                {
                  ...
                  explanation:
                    '12 tenses = 3 time frames × 4 aspects. Key for exams: Simple Present, Present Perfect, Simple Past, Past Perfect. Passive formula: Object + be (correct tense) + past participle.',
                  keyTakeaway:
                    '12 tenses = 3 time frames × 4 aspects. Passive = be + past participle.',
                },
                {
                  heading: 'Sentence Transformation',
                  explanation:
                    'Active to Passive: swap subject/object, add "be", use past participle. Direct to Indirect: backshift tense, change pronouns, adjust time expressions, remove quotation marks.',
                  keyTakeaway:
                    'Active→Passive: swap + "be" + past participle. Direct→Indirect: backshift + pronoun change.',
                },
              ],
              [
                {
                  ...
                  definition:
                    'Tense for actions completed recently or with present relevance. Form: have/has + past participle.',
                  example: '"She has finished her homework."',
                },
                {
                  term: 'Passive Voice',
                  definition: 'Sentence structure where the subject receives the action.',
                  example: '"The book was written by Rowling" (passive).',
                },
              ],
              [
                {
                  scenario: 'Exam: Change to passive: "The teacher corrects the papers."',
                  connection:
                    '"The papers are corrected by the teacher." -- Object (papers) + are + corrected + by + agent.',
                },
              ]
            ),
          },
              ...
              [
                {
                  ...
                  explanation:
                    "8-part format: (1) Sender's address, (2) Date, (3) Receiver's designation & address, (4) Subject line, (5) Salutation, (6) Body (3 paragraphs), (7) Complimentary close, (8) Signature. 'Yours faithfully' when you don't know the name; 'Yours sincerely' when you do.",
                  keyTakeaway:
                    '8-part format: address → date → receiver → subject → salutation → body → close → sign.',
                },
                {
                  heading: 'Types and Common Errors',
                  explanation:
                    'Types: (a) Letter to editor, (b) Letter to authority, (c) Letter of application. Common errors: missing subject line, wrong close, contractions in body. Use passive voice for polite distancing ("It is requested that...").',
                  keyTakeaway:
                    'Three types: editor / authority / application. No contractions; state purpose early.',
                },
              ],
              [
                {
                  term: 'Salutation',
                  definition: 'The greeting line at the start of a letter body.',
                  example: '"Dear Sir/Madam" (name unknown); "Dear Mr. Sharma" (name known).',
                },
                {
                  term: 'Complimentary Close',
                  definition: 'The polite ending before the signature.',
                  example: '"Yours faithfully" when salutation is Sir/Madam.',
                },
              ],
              [
                {
                  scenario: 'Write to Municipal Commissioner about waterlogging in your colony.',
                  connection:
                    "Letter to authority: salutation 'Dear Sir/Madam', subject 'Waterlogging in XYZ Colony', 3-paragraph body, close 'Yours faithfully'.",
                },
              ]
            ),
          },
      ...
      for (const tp of ch.topics) {
        ...
        for (const diff of ['easy', 'medium', 'hard']) {
          const test = await prisma.generatedTest.upsert({
            ...
            update: {
              title: `${tp.name} - ${diff[0].toUpperCase() + diff.slice(1)}`,
              status: 'approved',
            },
            create: {
              topicId: topic.id,
          ...
          await prisma.generatedQuestion.createMany({
            data: qBank[diff].map((q) => ({ testId: test.id, ...q })),
          });
          stats.tests++;
...
const MASTERY_PLAN = {
  ...
  arjun: [
    {
      sSlug: 'science',
      cSlug: 'electricity',
      tSlug: 'electric-current-and-circuit',
      weekAgo: 8,
      accuracy: 34,
      level: 'beginner',
      attempts: 8,
    ...
    {
      sSlug: 'science',
      cSlug: 'chemical-reactions-and-equations',
      tSlug: 'types-of-chemical-reactions',
      weekAgo: 6,
      accuracy: 39,
      level: 'beginner',
      attempts: 7,
    ...
    },
    {
      sSlug: 'science',
      cSlug: 'chemical-reactions-and-equations',
      tSlug: 'balancing-chemical-equations',
      weekAgo: 5,
      accuracy: 43,
      level: 'beginner',
      attempts: 6,
    ...
    },
    {
      sSlug: 'mathematics',
      cSlug: 'real-numbers',
      tSlug: 'fundamental-theorem-of-arithmetic',
      weekAgo: 3,
      accuracy: 65,
      level: 'intermediate',
      attempts: 11,
    ...
    {
      sSlug: 'mathematics',
      cSlug: 'pair-of-linear-equations',
      tSlug: 'graphical-method-of-solution',
      weekAgo: 2,
      accuracy: 67,
      level: 'intermediate',
      attempts: 10,
    ...
    },
    {
      sSlug: 'mathematics',
      cSlug: 'pair-of-linear-equations',
      tSlug: 'algebraic-methods-substitution-elimination',
      weekAgo: 1,
      accuracy: 69,
      level: 'intermediate',
      attempts: 9,
    ...
    {
      sSlug: 'social-science',
      cSlug: 'nationalism-in-india',
      tSlug: 'non-cooperation-movement',
      weekAgo: 8,
      accuracy: 30,
      level: 'beginner',
      attempts: 7,
    ...
    },
    {
      sSlug: 'social-science',
      cSlug: 'nationalism-in-india',
      tSlug: 'civil-disobedience-movement',
      weekAgo: 7,
      accuracy: 32,
      level: 'beginner',
      attempts: 8,
    ...
    {
      sSlug: 'social-science',
      cSlug: 'resources-and-development',
      tSlug: 'types-of-resources',
      weekAgo: 6,
      accuracy: 35,
      level: 'beginner',
      attempts: 6,
    ...
    },
    {
      sSlug: 'social-science',
      cSlug: 'resources-and-development',
      tSlug: 'land-use-pattern-in-india',
      weekAgo: 5,
      accuracy: 38,
      level: 'beginner',
      attempts: 5,
  ...
  priya: [
    ...
    {
      sSlug: 'english-language',
      cSlug: 'first-flight-literature',
      tSlug: 'a-letter-to-god',
      weekAgo: 2,
      accuracy: 93,
      level: 'expert',
      attempts: 15,
    ...
    },
    {
      sSlug: 'english-language',
      cSlug: 'first-flight-literature',
      tSlug: 'nelson-mandela-long-walk-to-freedom',
      weekAgo: 2,
      accuracy: 91,
      level: 'expert',
      attempts: 14,
    ...
    {
      sSlug: 'english-language',
      cSlug: 'grammar-and-writing-skills',
      tSlug: 'tenses-and-sentence-transformation',
      weekAgo: 1,
      accuracy: 92,
      level: 'expert',
      attempts: 14,
...
async function seedEngagement(studentId, cfg) {
  await prisma.studentEngagementStats.upsert({
    ...
    update: {
      ...
      totalSessionsCompleted: cfg.totalSessions,
  ...
  if (existing) {
    await prisma.studentStreak.update({
      ...
      data: { current: cfg.currentStreak, best: cfg.longestStreak, lastActive: daysAgo(0) },
    });
  } else {
    await prisma.studentStreak.create({
      data: {
        studentId,
        kind: 'daily',
        current: cfg.currentStreak,
        best: cfg.longestStreak,
...
async function seedLearningProfile(studentId, cfg) {
  await prisma.studentLearningProfile.upsert({
    ...
    update: {
      ...
      recommendations: { generatedAt: NOW.toISOString() },
    },
    create: {
      studentId,
      dailyTargetMin: cfg.dailyTargetMin,
...
async function seedMastery(studentId, key, topicMap) {
  ...
  for (const row of plan) {
    ...
    if (!topic) {
      warn(`  Topic not found: ${row.sSlug}/${row.cSlug}/${row.tSlug}`);
      continue;
    }
    ...
    const stm = await prisma.studentTopicMastery.upsert({
      ...
      update: {
        ...
        questionsAttempted: row.attempts,
        masteryLevel: row.level,
        lastAttemptedAt: targetDate,
      },
      create: {
        studentId,
        topicId: topic.id,
        subject: row.sSlug.replace(/-/g, ' '),
        chapter: row.cSlug.replace(/-/g, ' '),
        accuracy: row.accuracy,
        questionsAttempted: row.attempts,
        masteryLevel: row.level,
        lastAttemptedAt: targetDate,
...
const SESSION_PLANS = {
  arjun: [
    ...
    {
      tPath: ['science', 'electricity', 'electric-current-and-circuit'],
      state: 'COMPLETE',
      startOffset: daysAgo(10),
      durationMin: 35,
    },
    {
      tPath: ['science', 'electricity', 'ohms-law-and-resistance'],
      state: 'COMPLETE',
      startOffset: daysAgo(8),
      durationMin: 40,
    },
    {
      tPath: ['mathematics', 'real-numbers', 'euclids-division-lemma'],
      state: 'COMPLETE',
      startOffset: daysAgo(6),
      durationMin: 38,
    },
    {
      tPath: ['social-science', 'nationalism-in-india', 'non-cooperation-movement'],
      state: 'COMPLETE',
      startOffset: daysAgo(4),
      durationMin: 32,
    },
    {
      tPath: ['mathematics', 'pair-of-linear-equations', 'graphical-method-of-solution'],
      state: 'COMPLETE',
      startOffset: daysAgo(3),
      durationMin: 42,
    },
    // Current-week completed (needed for ParentWeeklyActivity.studyMinutes)
    {
      tPath: ['mathematics', 'real-numbers', 'fundamental-theorem-of-arithmetic'],
      state: 'COMPLETE',
      startOffset: daysAgo(1),
      durationMin: 35,
    },
    // Active session → P1 resume CTA on PrimaryActionCard
    {
      tPath: ['science', 'chemical-reactions-and-equations', 'types-of-chemical-reactions'],
      state: 'PRACTICE',
    ...
    {
      tPath: ['social-science', 'nationalism-in-india', 'civil-disobedience-movement'],
      state: 'EXPIRED',
      startOffset: daysAgo(18),
      durationMin: null,
    },
  ],
  priya: [
    {
      tPath: ['science', 'electricity', 'electric-current-and-circuit'],
      state: 'COMPLETE',
      startOffset: daysAgo(14),
      durationMin: 45,
    },
    {
      tPath: ['science', 'electricity', 'ohms-law-and-resistance'],
      state: 'COMPLETE',
      startOffset: daysAgo(12),
      durationMin: 48,
    },
    {
      tPath: ['mathematics', 'real-numbers', 'euclids-division-lemma'],
    ...
    },
    {
      tPath: ['social-science', 'nationalism-in-india', 'civil-disobedience-movement'],
      state: 'COMPLETE',
      startOffset: daysAgo(5),
      durationMin: 45,
    },
    {
      tPath: ['english-language', 'first-flight-literature', 'a-letter-to-god'],
      state: 'COMPLETE',
      startOffset: daysAgo(4),
      durationMin: 38,
    },
    {
      tPath: ['english-language', 'first-flight-literature', 'nelson-mandela-long-walk-to-freedom'],
      state: 'COMPLETE',
      startOffset: daysAgo(3),
      durationMin: 42,
    },
    ...
    {
      tPath: ['social-science', 'resources-and-development', 'types-of-resources'],
      state: 'COMPLETE',
      startOffset: hoursAgo(3),
      durationMin: 40,
    },
    // Active HOMEWORK session → PrimaryActionCard "resume homework"
    {
      tPath: ['english-language', 'grammar-and-writing-skills', 'formal-letter-writing'],
      state: 'HOMEWORK',
  ...
  ravi: [
    ...
    },
    {
      tPath: ['mathematics', 'real-numbers', 'fundamental-theorem-of-arithmetic'],
      state: 'COMPLETE',
      startOffset: daysAgo(9),
      durationMin: 42,
    },
    {
      tPath: ['mathematics', 'pair-of-linear-equations', 'graphical-method-of-solution'],
      state: 'COMPLETE',
      startOffset: daysAgo(7),
      durationMin: 38,
    },
    {
      tPath: [
...
async function seedSessions(studentId, key, topicMap) {
  ...
  for (const sc of plan) {
    ...
    if (!topic) {
      warn(`Session topic not found: ${sc.tPath.join('/')}`);
      continue;
    }
      ...
      await prisma.sessionEvent.createMany({
        ...
        data: [
          { sessionId: session.id, eventType: 'SESSION_STARTED', timestamp: startedAt },
          {
            ...
            eventType: 'SESSION_OVERVIEW_VIEWED',
            timestamp: addMinutes(startedAt, 1),
          },
          {
            sessionId: session.id,
            eventType: 'PHASE_STARTED',
            timestamp: addMinutes(startedAt, 3),
            metadata: { phase: 'EXPLANATION' },
          },
          {
            sessionId: session.id,
            eventType: 'QUESTION_ANSWERED',
            timestamp: addMinutes(startedAt, sc.durationMin - 10),
            metadata: { correct: true, score: 80 },
          },
          {
            sessionId: session.id,
...
const HW_QUESTIONS = [
  {
    id: 'hwq1',
    text: 'Explain the concept in your own words. (5 marks)',
    type: 'short_answer',
    marks: 5,
  },
  {
  ...
  {
    id: 'hwq3',
    text: 'Solve the given problem step by step. (3 marks)',
    type: 'short_answer',
    marks: 3,
  },
];
...
async function seedHomework(studentId, key, topicMap) {
  ...
  for (const hw of plan) {
    ...
    const topic = (topicMap[sSlug] || {})[cSlug]?.[tSlug];
    if (!topic) {
      warn(`HW topic not found: ${hw.tPath.join('/')}`);
      continue;
    }
        ...
        data: [
          {
            ...
            questionId: 'hwq1',
            studentAnswer: {
              text: 'This concept involves the fundamental principles as explained in the notes.',
            },
            isCorrect: true,
          },
          {
            assignmentId: assignment.id,
            questionId: 'hwq2',
            studentAnswer: { selected: 'Option A' },
            isCorrect: true,
          },
          {
            assignmentId: assignment.id,
            questionId: 'hwq3',
            studentAnswer: {
              text: 'Step 1: Identify. Step 2: Apply formula. Step 3: Calculate result.',
            },
            isCorrect: hw.score ? hw.score > 70 : null,
          },
        ],
      });
    }
...
const CATALOG_ENTRIES = [
  {
    contentId: 'cat:sci:electricity:notes',
    title: 'Electricity - Study Notes',
    description: "Complete notes on electric current, Ohm's law and circuits.",
    type: 'notes',
    subject: 'Science',
    board: 'cbse',
    grade: '10',
  ...
  {
    contentId: 'cat:sci:chemistry:practice',
    title: 'Chemical Reactions - Practice Set',
    description: '50 practice problems on types of reactions and balancing.',
    type: 'practice',
    subject: 'Science',
    board: 'cbse',
    grade: '10',
  ...
  {
    contentId: 'cat:math:realnumbers:notes',
    title: 'Real Numbers - Concept Guide',
    description: "Visual guide to Euclid's lemma and prime factorisation.",
    type: 'notes',
    subject: 'Mathematics',
    board: 'cbse',
    grade: '10',
  ...
  {
    contentId: 'cat:math:linearequations:test',
    title: 'Linear Equations - Quick Test',
    description: '15-minute test on graphical and algebraic methods.',
    type: 'test',
    subject: 'Mathematics',
    board: 'cbse',
    grade: '10',
  ...
  {
    contentId: 'cat:socSci:nationalism:notes',
    title: 'Nationalism in India - Timeline',
    description: 'Illustrated timeline of Non-Cooperation and Civil Disobedience.',
    type: 'notes',
    ...
    language: 'en',
    difficulty: 'easy',
    tags: ['nationalism', 'Gandhi', 'independence'],
  },
  {
    contentId: 'cat:socSci:resources:practice',
    title: 'Resources - Classification Practice',
    description: 'Classify resources by origin, exhaustibility and ownership.',
    type: 'practice',
    subject: 'Social Science',
    board: 'cbse',
    grade: '10',
    language: 'en',
    difficulty: 'easy',
    tags: ['resources', 'land use', 'environment'],
  },
  {
    contentId: 'cat:eng:literature:notes',
    title: 'First Flight - Story Analysis',
    description: 'Theme and character analysis for Letter to God and Mandela.',
    type: 'notes',
    ...
    language: 'en',
    difficulty: 'easy',
    tags: ['literature', 'comprehension', 'themes'],
  },
  {
    contentId: 'cat:eng:grammar:practice',
    title: 'Grammar Booster - Tenses & Voice',
    description: '100 transformation exercises: tenses, active/passive, reported speech.',
    type: 'practice',
    subject: 'English Language',
    board: 'cbse',
    grade: '10',
    language: 'en',
    difficulty: 'medium',
    tags: ['grammar', 'tenses', 'voice', 'letter writing'],
  },
];
  ...
  for (const rec of REC_PLANS[key] || []) {
    await prisma.contentRecommendation.upsert({
      ...
      create: {
        ...
        isShown: rec.isShown || false,
        isClicked: rec.isClicked || false,
        isCompleted: rec.isCompleted || false,
        isIgnored: rec.isIgnored || false,
        firstShownAt: rec.firstShownAt || null,
        lastShownAt: rec.firstShownAt || null,
  ...
  const traces = [
    {
      ...
      entityType: 'notes',
      score: 72.5,
      signals: { WEAK_SUBJECT_BOOST: 25, PROFILE_MATCH: 30, FRESHNESS: 5, ENGAGEMENT_HISTORY: -10 },
    },
    {
      contentId: 'cat:socSci:nationalism:notes',
      entityType: 'notes',
    ...
    },
    {
      ...
      entityType: 'practice',
      score: 45.0,
      signals: { PROFILE_MATCH: 30, FRESHNESS: 5, DIFFICULTY_MATCH: 10 },
    },
  ];
  for (const t of traces) {
    await prisma.recommendationTrace.create({
      data: {
        ...
        entityId: t.contentId,
        score: t.score,
        signals: t.signals,
        engineVersion: 'seed-v2',
      },
    });
  }
}
...
const DAILY_TASK_PLANS = {
  arjun: {
    taskType: 'practice',
    title: "Practice: Ohm's Law Problems",
    description:
      'Solve 5 numerical problems on V=IR and resistivity to strengthen your weak topic.',
    subject: 'Science',
    estimatedTimeMin: 20,
    status: 'pending',
  ...
  priya: {
    taskType: 'learn',
    title: 'Learn: Formal Letter Writing',
    description: 'Study the 8-part letter format and attempt one letter to the school principal.',
    subject: 'English Language',
    estimatedTimeMin: 30,
    status: 'completed',
    motivationMessage: 'Excellent work! Letter structure mastered.',
  },
  ravi: {
    taskType: 'fix_gap',
    title: 'Fix gap: Electric Current Concepts',
    description:
      'Your mastery on Electric Current is at 35%. Re-read the note and attempt the easy test.',
    subject: 'Science',
    estimatedTimeMin: 25,
    status: 'pending',
    motivationMessage: null,
...
async function seedDailyTask(studentId, key, topicMap) {
  ...
  let topicId = null;
  if (key === 'arjun')
    topicId = topicMap['science']?.['electricity']?.['ohms-law-and-resistance']?.id ?? null;
  if (key === 'priya')
    topicId =
      topicMap['english-language']?.['grammar-and-writing-skills']?.['formal-letter-writing']?.id ??
      null;
  if (key === 'ravi')
    topicId = topicMap['science']?.['electricity']?.['electric-current-and-circuit']?.id ?? null;
  ...
  await prisma.dailyTask.upsert({
    ...
    create: {
      ...
      topicId,
      subject: cfg.subject,
      estimatedTimeMin: cfg.estimatedTimeMin,
      status: cfg.status,
...
async function seedLegacySessions(studentId, key) {
  ...
  await prisma.learningSession.create({
    data: {
      ...
      activityRef: 'science-electricity-practice',
...
const WEEKLY_SUMMARY_PLANS = {
  ...
  priya: [
    ...
    },
    {
      ...
      minutes: 220,
      sessions: 6,
      subjects: ['Social Science', 'English Language'],
    },
    {
      wk: 3,
      topics: 4,
    ...
    },
    {
      ...
      minutes: 130,
      sessions: 4,
      subjects: ['English Language', 'Social Science'],
    },
  ],
  ravi: [
    ...
    },
    {
      ...
      minutes: 130,
      sessions: 5,
      subjects: ['Social Science', 'Mathematics'],
    },
    {
      wk: 1,
      topics: 2,
...
async function seedParents(studentIdByKey) {
  ...
  for (const p of PARENTS) {
    ...
    if (!studentId) {
      warn(`Parent ${p.name}: student key '${p.studentKey}' not found`);
      continue;
    }
...
async function runValidations(studentIds) {
  ...
  const topicCount = await prisma.topicDef.count({
    where: { status: 'approved', lifecycle: 'active' },
  });
  topicCount >= 16
    ? pass(`Curriculum: ${topicCount} approved active topics (16 expected)`)
    : warn(`Curriculum: only ${topicCount} approved topics -- need ≥16`);

  const noteCount = await prisma.topicNote.count({ where: { status: 'approved', language: 'en' } });
  noteCount >= 16
    ? pass(`TopicNote: ${noteCount} approved English notes`)
    : warn(`TopicNote: only ${noteCount} -- need ≥16`);

  // ── student core ────────────────────────────────────────────────────────────
  const engStats = await prisma.studentEngagementStats.count({
    where: { studentId: { in: studentIds } },
  });
  engStats === 3
    ? pass('StudentEngagementStats: all 3 students')
    : warn(`StudentEngagementStats: ${engStats}/3`);

  const streaks = await prisma.studentStreak.count({
    where: { studentId: { in: studentIds }, kind: 'daily' },
  });
  streaks >= 3 ? pass('StudentStreak (daily): all students') : warn(`StudentStreak: ${streaks}/3`);

  const profiles = await prisma.studentLearningProfile.count({
    where: { studentId: { in: studentIds } },
  });
  profiles === 3
    ? pass('StudentLearningProfile: all 3 students')
    : warn(`StudentLearningProfile: ${profiles}/3`);

  // ── mastery ─────────────────────────────────────────────────────────────────
  const stmCount = await prisma.studentTopicMastery.count({
    where: { studentId: { in: studentIds } },
  });
  stmCount >= 28
    ? pass(`StudentTopicMastery: ${stmCount} records (covers 8-week trend)`)
    : warn(`StudentTopicMastery: only ${stmCount} records`);

  const stpCount = await prisma.studentTopicProgress.count({
    where: { studentId: { in: studentIds } },
  });
  stpCount >= 28
    ? pass(`StudentTopicProgress: ${stpCount} records`)
    : warn(`StudentTopicProgress: only ${stpCount}`);

  // ── weak topics (student dashboard gate: mastery < 0.4) ────────────────────
  const weakStp = await prisma.studentTopicProgress.count({
    where: { studentId: { in: studentIds }, mastery: { lt: 0.4 } },
  });
  weakStp >= 5
    ? pass(
        `Weak topics (mastery<0.4): ${weakStp} rows -- WeakTopicsSection will render for Arjun + Ravi`
      )
  ...
  const parentWeak = await prisma.studentTopicProgress.count({
    where: { studentId: { in: studentIds }, mastery: { lt: 0.4 }, practiceCount: { gt: 5 } },
  });
  parentWeak >= 4
    ? pass(
        `Parent weak topics (mastery<0.4, practiceCount>5): ${parentWeak} -- ParentWeakTopics card will render`
      )
    : warn(
        `Parent weak topics: only ${parentWeak} -- ParentWeakTopics card needs mastery<0.4 AND practiceCount>5`
      );

  // ── 8-week trend spread (StudentTopicMastery.updatedAt across 8 weeks) ──────
  const eightWeeksAgo = weeksAgo(8);
  const trendCoverage = await prisma.studentTopicMastery.count({
    where: { studentId: { in: studentIds }, updatedAt: { gte: eightWeeksAgo } },
  });
  trendCoverage >= 20
    ? pass(
        `STM updatedAt spread: ${trendCoverage} rows within last 8 weeks (ParentImprovementTrend)`
      )
    : warn(`STM updatedAt spread: only ${trendCoverage} rows in last 8 weeks`);

  // ── sessions ────────────────────────────────────────────────────────────────
  const totalSess = await prisma.structuredSession.count({
    where: { studentId: { in: studentIds } },
  });
  totalSess >= 15
    ? pass(`StructuredSession: ${totalSess} total`)
    : warn(`StructuredSession: only ${totalSess}`);

  const completedS = await prisma.structuredSession.count({
    where: { studentId: { in: studentIds }, state: 'COMPLETE' },
  });
  completedS >= 12
    ? pass(`COMPLETE sessions: ${completedS}`)
    : warn(`COMPLETE sessions: only ${completedS}`);

  const activeSess = await prisma.structuredSession.count({
    where: { studentId: { in: studentIds }, state: { notIn: ['COMPLETE', 'EXPIRED'] } },
  });
  activeSess >= 3
    ? pass(`Active (in-progress) sessions: ${activeSess} -- PrimaryActionCard resume CTAs ready`)
    : warn(`Active sessions: only ${activeSess}`);

  const expiredS = await prisma.structuredSession.count({
    where: { studentId: { in: studentIds }, state: 'EXPIRED' },
  });
  ...
  const thisWeekSess = await prisma.structuredSession.count({
    where: {
      ...
      state: 'COMPLETE',
      startedAt: { gte: thisWeekMon, lte: thisWeekSun },
      completedAt: { not: null },
    },
  });
  thisWeekSess >= 3
    ? pass(
        `Current-week completed sessions: ${thisWeekSess} (with completedAt → studyMinutes will be non-zero)`
      )
    : warn(
        `Current-week sessions: only ${thisWeekSess} -- ParentWeeklyActivity may show 0 minutes`
      );
  ...
  // ── homework ─────────────────────────────────────────────────────────────────
  const hwPending = await prisma.homeworkAssignment.count({
    where: { studentId: { in: studentIds }, status: 'PENDING' },
  });
  const hwOverdue = await prisma.homeworkAssignment.count({
    where: { studentId: { in: studentIds }, status: 'OVERDUE' },
  });
  const hwSubmit = await prisma.homeworkAssignment.count({
    where: { studentId: { in: studentIds }, status: 'SUBMITTED' },
  });
  const hwGraded = await prisma.homeworkAssignment.count({
    where: { studentId: { in: studentIds }, status: 'GRADED' },
  });
  hwPending >= 2
    ? pass(`PENDING homework: ${hwPending}`)
    : warn(`PENDING homework: only ${hwPending}`);
  hwOverdue >= 2
    ? pass(`OVERDUE homework: ${hwOverdue} -- HomeworkPendingCard will show (red)`)
    : warn(`OVERDUE homework: only ${hwOverdue}`);
  ...
  const p0hw = await prisma.homeworkAssignment.count({
    where: {
      ...
      dueDate: { lte: hoursFromNow(48) },
    },
  });
  p0hw >= 2
    ? pass(`P0 homework (due ≤ 48h): ${p0hw} -- PrimaryActionCard will show URGENT homework CTA`)
    : warn(`P0 homework trigger: only ${p0hw} -- check dueDate values`);

  // ── recommendations ──────────────────────────────────────────────────────────
  const catalog = await prisma.contentCatalog.count({
    where: { active: true, board: 'cbse', grade: '10' },
  });
  catalog >= 8
    ? pass(`ContentCatalog: ${catalog} active CBSE Grade 10 entries`)
    : warn(`ContentCatalog: only ${catalog}`);

  const recs = await prisma.contentRecommendation.count({ where: { userId: { in: studentIds } } });
  recs >= 6
    ? pass(`ContentRecommendation: ${recs} records (shown/clicked/completed/ignored states)`)
    : warn(`ContentRecommendation: only ${recs}`);

  const traces = await prisma.recommendationTrace.count({
    where: { studentId: { in: studentIds } },
  });
  traces >= 3
    ? pass(`RecommendationTrace: ${traces} audit rows`)
    : warn(`RecommendationTrace: none`);

  // ── daily tasks ───────────────────────────────────────────────────────────────
  const dailyTasks = await prisma.dailyTask.count({ where: { studentId: { in: studentIds } } });
  dailyTasks >= 3
    ? pass(`DailyTask: ${dailyTasks} tasks seeded (today)`)
    : warn(`DailyTask: only ${dailyTasks}`);

  // ── attention flags ────────────────────────────────────────────────────────────
  const flags = await prisma.attentionFlag.count({
    where: { studentId: { in: studentIds }, resolved: false },
  });
  flags >= 3
    ? pass(`AttentionFlag: ${flags} unresolved low-mastery flags`)
    : warn(`AttentionFlag: only ${flags}`);

  // ── readiness status ───────────────────────────────────────────────────────────
  const readiness = await prisma.readinessStatus.count({
    where: { studentId: { in: studentIds } },
  });
  readiness >= 8
    ? pass(`ReadinessStatus: ${readiness} subject readiness records`)
    : warn(`ReadinessStatus: only ${readiness}`);

  // ── weekly summaries ────────────────────────────────────────────────────────────
  const weeklySumm = await prisma.weeklyStudentSummary.count({
    where: { studentId: { in: studentIds } },
  });
  weeklySumm >= 20
    ? pass(`WeeklyStudentSummary: ${weeklySumm} rows (8-week parent trend coverage)`)
    : warn(`WeeklyStudentSummary: only ${weeklySumm} -- trend chart may be sparse`);

  // ── subject summaries ────────────────────────────────────────────────────────────
  const subjSumm = await prisma.subjectProgressSummary.count({
    where: { studentId: { in: studentIds } },
  });
  subjSumm >= 10
    ? pass(`SubjectProgressSummary: ${subjSumm} rows (ParentSubjectMastery card)`)
    : warn(`SubjectProgressSummary: only ${subjSumm}`);

  // ── parent links ────────────────────────────────────────────────────────────────
  const pLinks = await prisma.parentStudent.count({
    where: { studentId: { in: studentIds }, status: 'active' },
  });
  pLinks >= 2
    ? pass(`ParentStudent links (active): ${pLinks}`)
    : warn(`ParentStudent active links: only ${pLinks}`);
}
...
async function main() {
  ...
  console.log(
    `  ✓ +${cStats.subjects} subjects, +${cStats.chapters} chapters, +${cStats.topics} topics`
  );
  console.log(
    `  ✓ +${cStats.notes} notes, +${cStats.tests} tests, +${cStats.questions} questions\n`
  );
  ...
  for (const cfg of STUDENTS) {
    ...
    console.log(
      `     ✓ LearningProfile  target=${cfg.dailyTargetMin}min/day, ${cfg.studyDaysPerWeek}d/wk, weak=[${cfg.weakSubjects.join(', ') || 'none'}]`
    );

    await seedEngagement(user.id, cfg);
    console.log(
      `     ✓ Streak           current=${cfg.currentStreak}d best=${cfg.longestStreak}d points=${cfg.learningPoints}`
    );

    const masteryCount = await seedMastery(user.id, cfg.key, freshMap);
    console.log(
      `     ✓ TopicMastery     ${masteryCount} topics seeded (updatedAt backfilled across 8 weeks)`
    );
    ...
    console.log(
      `     ✓ Sessions         ${sessions.length} total (${comp} COMPLETE, ${active} active, ${expired} EXPIRED)`
    );
...
function printReport(studentIdByKey) {
  ...
  line();
  line(
    '  kavita.sharma@parent.test  →  Arjun Sharma  (parent sees overdue HW, weak Science + SocSci)'
  );
  ...
  line(
    '       GET /api/parent/weak-topics?studentId=<arjun-id>       → 5 weak topics (mastery<0.4)'
  );
