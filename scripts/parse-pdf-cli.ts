...
async function main() {
  ...
  if (!filePath) {
    console.error('Usage: node ingest.js --file <path> --board CBSE --subject <subjectId|slug> --grade <grade> [--lang en]')
    process.exit(1)
  }
  ...
  console.log(`Done. created=${chunksCreated} skipped=${chunksSkipped} pendingEmbeds=${embeddingsPending} errors=${errors}`)
