/**
 * FILE OBJECTIVE:
 * - Quick audit: list files that call `sendMail` or `sendMailSafe` and show a
 *   short snippet to help find admin vs user sends and identify calls that
 *   might suppress errors for admin-critical alerts.
 *
 * USAGE: node scripts/audit-email-senders.ts
 */
