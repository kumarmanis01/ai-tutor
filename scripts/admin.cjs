...
(async () => {
  ...
  try {
    switch (command) {
      case 'suspend-user':
        await suspendUser(prisma, args);
        break;
      case 'reactivate-user':
        await reactivateUser(prisma, args);
        break;
      case 'reset-diagnostic':
        await resetDiagnostic(prisma, args);
        break;
      case 'extend-subscription':
        await extendSubscription(prisma, args);
        break;
      case 'list-escalations':
        await listEscalations(prisma);
        break;
      case 'list-quarantined':
        await listQuarantined(prisma);
        break;
      case 'view-audit-log':
        await viewAuditLog(prisma, args);
        break;
      case 'change-grade':
        await changeGrade(prisma, args);
        break;
      default:
