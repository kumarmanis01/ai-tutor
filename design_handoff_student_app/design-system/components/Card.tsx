/**
 * Card — surface wrapper with three variants.
 *
 *   - default  — white surface, 1 px line, rounded-xl (16). Most cards.
 *   - warm     — warm-cream surface. Stat / sidebar cards.
 *   - hero     — soft warm gradient, rounded-2xl (24). Welcome banner / identity hero only.
 */
