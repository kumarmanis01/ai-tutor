...
export function renderTemplate(name: 'topic-notes', params: TopicNotesParams): { prompt: string; schemaHash: string; version: string }
export function renderTemplate(name: 'topic-questions', params: TopicQuestionsParams): { prompt: string; schemaHash: string; version: string }
export function renderTemplate(name: 'bilingual-notes', params: BilingualNotesParams): { prompt: string; schemaHash: string; version: string }
export function renderTemplate(name: 'assemble', params: AssembleParams): { prompt: string; schemaHash: string; version: string }
export function renderTemplate(name: 'syllabus', params: SyllabusParams): { prompt: string; schemaHash: string; version: string }
export function renderTemplate(name: 'chapters', params: ChaptersParams): { prompt: string; schemaHash: string; version: string }
