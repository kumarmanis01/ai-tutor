...
export function trackLessonViewed(opts: {
  userId?: string;
  courseId?: string;
  lessonIdx?: number;
  metadata?: any;
...
export function trackLessonCompleted(opts: {
  userId?: string;
  courseId?: string;
  lessonIdx?: number;
  metadata?: any;
...
export function trackQuizAttempted(opts: {
  userId?: string;
  courseId?: string;
  lessonIdx?: number;
  metadata?: any;
...
export function trackQuizPassed(opts: {
  userId?: string;
  courseId?: string;
  lessonIdx?: number;
  metadata?: any;
