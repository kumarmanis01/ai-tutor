...
export const LOCAL_STRINGS: Record<string, Record<string, string>> = {
  ...
  hi: {
    ...
    predictedRangeLabel: '\u0905\u0928\u0941\u092e\u093e\u0928\u093f\u062a \u092c\u094b\u0930\u094d\u0921 \u0905\u0902\u0915',
    benchmarkingOptInLabel: '\u0938\u093e\u0902\u0916\u094d\u092f\u093f\u0915\u0940\u092f \u062a\u0941\u0932\u0928\u093e \u0926\u093f\u0916\u093e\u090f\u0902 (\u0905\u0928\u093e\u092e\u093f\u0924)',
    benchmarkingCopy: '\u0906\u092a\u0915\u0947 \u092c\u091a\u094d\u091a\u0947 \u0915\u0940 \u092e\u0939\u093e\u0930\u0924 \u0939\u092e\u093e\u0930\u0947 \u092e\u0902\u091a \u092a\u0930 \u0909\u0928\u0915\u0947 \u0915\u0915\u094d\u0937\u093e \u0915\u0947 {pct}% \u091b\u093e\u0924\u094d\u0930\u094b\u0902 \u0938\u0947 \u0913\u092a\u0930 \u0939\u0948\u0964',
  },
}
...
export function predictDaysToReadiness(
  ...
  const effectiveGain = Number.isFinite(avgGainPerSession) && avgGainPerSession > 0
    ? avgGainPerSession
