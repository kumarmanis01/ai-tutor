...
const notificationsSent = new client.Counter({ name: 'notifications_sent_total', help: 'Total parent notifications sent', labelNames: ['type'] as const })
const notificationsFailed = new client.Counter({ name: 'notifications_failed_total', help: 'Total parent notifications failed', labelNames: ['type', 'reason'] as const })

// Redis / suppression metrics
const redisErrors = new client.Counter({ name: 'redis_client_errors_total', help: 'Redis client error events' })
