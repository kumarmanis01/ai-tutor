...
--    Wrapped in a DO block so dev machines without pgvector skip these gracefully.
--    On Neon (production) the vector extension is enabled and the indexes are created.
DO $$
BEGIN
