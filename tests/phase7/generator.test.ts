...
const validLesson = {
  ...
  explanation: {
    ...
    concepts: [{ title: 'Concept 1', explanation: 'Deep explanation '.repeat(10) }],
  },
  keyTakeaways: ['Takeaway 1', 'Takeaway 2'],
  practice: {
    prompt: 'Practice prompt describing the coding task in detail.'.repeat(2),
    expectedOutcome: 'Expected outcome describing what success looks like in detail.'.repeat(2),
  },
