/**
 * UNIT TESTS: app/api/subjects/[id]
 *
...
describe('GET /api/subjects/[id]', () => {
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/subjects/[id]/route');
    const request = new Request('http://localhost:3000/api/subjects/[id]', {
      method: 'GET',
    });
...
describe('PUT /api/subjects/[id]', () => {
  ...
  it('should return success response', async () => {
    ...
    const { PUT } = await import('@/app/api/subjects/[id]/route');
    const request = new Request('http://localhost:3000/api/subjects/[id]', {
      method: 'PUT',
      body: JSON.stringify({
...
describe('DELETE /api/subjects/[id]', () => {
  ...
  it('should return success response', async () => {
    ...
    const { DELETE } = await import('@/app/api/subjects/[id]/route');
    const request = new Request('http://localhost:3000/api/subjects/[id]', {
      method: 'DELETE',
    });
