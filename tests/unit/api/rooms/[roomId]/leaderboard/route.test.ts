/**
 * UNIT TESTS: app/api/rooms/[roomId]/leaderboard
 *
...
describe('GET /api/rooms/[roomId]/leaderboard', () => {
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/rooms/[roomId]/leaderboard/route');
    const request = new Request('http://localhost:3000/api/rooms/[roomId]/leaderboard', {
      method: 'GET',
    });
