/**
 * UNIT TESTS: app/api/rooms/[roomId]/quiz
 *
...
describe('GET /api/rooms/[roomId]/quiz', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/rooms/[roomId]/quiz/route');
    const request = new Request('http://localhost:3000/api/rooms/[roomId]/quiz', {
      method: 'GET',
    });
