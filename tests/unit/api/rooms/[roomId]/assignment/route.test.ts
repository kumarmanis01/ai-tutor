/**
 * UNIT TESTS: app/api/rooms/[roomId]/assignment
 *
...
describe('GET /api/rooms/[roomId]/assignment', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/rooms/[roomId]/assignment/route');
    const request = new Request('http://localhost:3000/api/rooms/[roomId]/assignment', {
      method: 'GET',
    });

    const response = await GET(request, { params: {
      "roomId": "mock-roomId-123"
} });
