/**
 * UNIT TESTS: app/api/rooms/message
 *
...
describe('POST /api/rooms/message', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/rooms/message/route');
    const request = new Request('http://localhost:3000/api/rooms/message', {
      method: 'POST',
      body: JSON.stringify({
