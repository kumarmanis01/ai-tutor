/**
 * UNIT TESTS: app/api/dashboard/continue-learning
 *
...
describe('GET /api/dashboard/continue-learning', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/dashboard/continue-learning/route');
    const request = new Request('http://localhost:3000/api/dashboard/continue-learning', {
      method: 'GET',
    });
