/**
 * UNIT TESTS: app/api/dashboard/recommendations/track
 *
...
describe('POST /api/dashboard/recommendations/track', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/dashboard/recommendations/track/route');
    const request = new Request('http://localhost:3000/api/dashboard/recommendations/track', {
      method: 'POST',
      body: JSON.stringify({
