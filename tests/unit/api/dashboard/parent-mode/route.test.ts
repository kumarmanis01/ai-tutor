/**
 * UNIT TESTS: app/api/dashboard/parent-mode
 *
...
describe('GET /api/dashboard/parent-mode', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/dashboard/parent-mode/route');
    const request = new Request('http://localhost:3000/api/dashboard/parent-mode', {
      method: 'GET',
    });
