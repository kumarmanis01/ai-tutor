/**
 * UNIT TESTS: app/api/dashboard/progress
 *
...
describe('GET /api/dashboard/progress', () => {
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/dashboard/progress/route');
    const request = new Request('http://localhost:3000/api/dashboard/progress', {
      method: 'GET',
    });
