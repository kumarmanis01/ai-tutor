/**
 * UNIT TESTS: app/api/dashboard/feature-grid
 *
...
describe('GET /api/dashboard/feature-grid', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/dashboard/feature-grid/route');
    const request = new Request('http://localhost:3000/api/dashboard/feature-grid', {
      method: 'GET',
    });
