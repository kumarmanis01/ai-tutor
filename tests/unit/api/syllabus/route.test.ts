...
describe('GET /api/syllabus', () => {
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/syllabus/route');
    const request = new Request('http://localhost:3000/api/syllabus', {
      method: 'GET',
    });
...
describe('POST /api/syllabus', () => {
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/syllabus/route');
    const request = new Request('http://localhost:3000/api/syllabus', {
      method: 'POST',
      body: JSON.stringify({
