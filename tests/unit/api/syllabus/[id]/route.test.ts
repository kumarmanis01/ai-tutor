/**
 * UNIT TESTS: app/api/syllabus/[id]
 *
...
describe('GET /api/syllabus/[id]', () => {
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/syllabus/[id]/route');
    const request = new Request('http://localhost:3000/api/syllabus/[id]', {
      method: 'GET',
    });
...
describe('PUT /api/syllabus/[id]', () => {
  ...
  it('should return success response', async () => {
    ...
    const { PUT } = await import('@/app/api/syllabus/[id]/route');
    const request = new Request('http://localhost:3000/api/syllabus/[id]', {
      method: 'PUT',
      body: JSON.stringify({
...
describe('DELETE /api/syllabus/[id]', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { DELETE } = await import('@/app/api/syllabus/[id]/route');
    const request = new Request('http://localhost:3000/api/syllabus/[id]', {
      method: 'DELETE',
    });
