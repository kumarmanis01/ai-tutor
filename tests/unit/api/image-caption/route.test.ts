/**
 * UNIT TESTS: app/api/image-caption
 *
...
describe('POST /api/image-caption', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/image-caption/route');
    const request = new Request('http://localhost:3000/api/image-caption', {
      method: 'POST',
      body: JSON.stringify({
