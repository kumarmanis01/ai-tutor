/**
 * UNIT TESTS: app/api/admin/analytics/signals
 *
...
describe('GET /api/admin/analytics/signals', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/analytics/signals/route');
    const request = new Request('http://localhost:3000/api/admin/analytics/signals', {
      method: 'GET',
    });
