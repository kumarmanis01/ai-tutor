/**
 * UNIT TESTS: app/api/admin/analytics/funnel/[courseId]
 *
...
describe('GET /api/admin/analytics/funnel/[courseId]', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/analytics/funnel/[courseId]/route');
    const request = new Request('http://localhost:3000/api/admin/analytics/funnel/[courseId]', {
      method: 'GET',
    });
