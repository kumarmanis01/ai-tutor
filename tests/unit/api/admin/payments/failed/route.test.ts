/**
 * UNIT TESTS: app/api/admin/payments/failed
 *
...
describe('GET /api/admin/payments/failed', () => {
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/payments/failed/route');
    const request = new Request('http://localhost:3000/api/admin/payments/failed', {
      method: 'GET',
    });
