/**
 * UNIT TESTS: app/api/admin/api-usage
 *
...
describe('GET /api/admin/api-usage', () => {
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/api-usage/route');
    const request = new Request('http://localhost:3000/api/admin/api-usage', {
      method: 'GET',
    });
