/**
 * UNIT TESTS: app/api/admin/ai/status
 *
...
describe('GET /api/admin/ai/status', () => {
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/ai/status/route');
    const request = new Request('http://localhost:3000/api/admin/ai/status', {
      method: 'GET',
    });
