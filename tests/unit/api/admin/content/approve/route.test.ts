/**
 * UNIT TESTS: app/api/admin/content/approve
 *
...
describe('POST /api/admin/content/approve', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/content/approve/route');
    const request = new Request('http://localhost:3000/api/admin/content/approve', {
      method: 'POST',
      body: JSON.stringify({
