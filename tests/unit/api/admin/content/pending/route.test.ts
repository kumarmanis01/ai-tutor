/**
 * UNIT TESTS: app/api/admin/content/pending
 *
...
describe('GET /api/admin/content/pending', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/content/pending/route');
    const request = new Request('http://localhost:3000/api/admin/content/pending', {
      method: 'GET',
    });
