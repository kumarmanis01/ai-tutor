/**
 * UNIT TESTS: app/api/admin/challenges/create
 *
...
describe('POST /api/admin/challenges/create', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/challenges/create/route');
    const request = new Request('http://localhost:3000/api/admin/challenges/create', {
      method: 'POST',
      body: JSON.stringify({
