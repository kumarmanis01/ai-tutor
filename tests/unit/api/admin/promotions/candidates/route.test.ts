/**
 * UNIT TESTS: app/api/admin/promotions/candidates
 *
...
describe('POST /api/admin/promotions/candidates', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/promotions/candidates/route');
    const request = new Request('http://localhost:3000/api/admin/promotions/candidates', {
      method: 'POST',
      body: JSON.stringify({
...
describe('GET /api/admin/promotions/candidates', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/promotions/candidates/route');
    const request = new Request('http://localhost:3000/api/admin/promotions/candidates', {
      method: 'GET',
    });
