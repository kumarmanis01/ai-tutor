/**
 * UNIT TESTS: app/api/admin/promotions/[id]/approve
 *
...
describe('POST /api/admin/promotions/[id]/approve', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/promotions/[id]/approve/route');
    const request = new Request('http://localhost:3000/api/admin/promotions/[id]/approve', {
      method: 'POST',
      body: JSON.stringify({
