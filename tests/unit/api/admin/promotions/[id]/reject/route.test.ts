/**
 * UNIT TESTS: app/api/admin/promotions/[id]/reject
 *
...
describe('POST /api/admin/promotions/[id]/reject', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/promotions/[id]/reject/route');
    const request = new Request('http://localhost:3000/api/admin/promotions/[id]/reject', {
      method: 'POST',
      body: JSON.stringify({
