/**
 * UNIT TESTS: app/api/admin/jobs/status
 *
...
describe('GET /api/admin/jobs/status', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/jobs/status/route');
    const request = new Request('http://localhost:3000/api/admin/jobs/status', {
      method: 'GET',
    });
