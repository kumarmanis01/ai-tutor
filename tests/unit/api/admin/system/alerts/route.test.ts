/**
 * UNIT TESTS: app/api/admin/system/alerts
 *
...
describe('GET /api/admin/system/alerts', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/system/alerts/route');
    const request = new Request('http://localhost:3000/api/admin/system/alerts', {
      method: 'GET',
    });
