/**
 * UNIT TESTS: app/api/admin/system/telemetry
 *
...
describe('GET /api/admin/system/telemetry', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/system/telemetry/route');
    const request = new Request('http://localhost:3000/api/admin/system/telemetry', {
      method: 'GET',
    });
