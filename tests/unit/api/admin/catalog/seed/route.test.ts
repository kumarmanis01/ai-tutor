/**
 * UNIT TESTS: app/api/admin/catalog/seed
 *
...
describe('POST /api/admin/catalog/seed', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/catalog/seed/route');
    const request = new Request('http://localhost:3000/api/admin/catalog/seed', {
      method: 'POST',
      body: JSON.stringify({
