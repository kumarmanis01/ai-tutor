/**
 * UNIT TESTS: app/api/admin/catalog/parse-image
 *
...
describe('POST /api/admin/catalog/parse-image', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/catalog/parse-image/route');
    const request = new Request('http://localhost:3000/api/admin/catalog/parse-image', {
      method: 'POST',
      body: JSON.stringify({
