/**
 * UNIT TESTS: app/api/admin/catalog/parse-pdf
 *
...
describe('POST /api/admin/catalog/parse-pdf', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/catalog/parse-pdf/route');
    const request = new Request('http://localhost:3000/api/admin/catalog/parse-pdf', {
      method: 'POST',
      body: JSON.stringify({
