/**
 * UNIT TESTS: app/api/admin/orchestrator/status
 *
...
describe('GET /api/admin/orchestrator/status', () => {
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/orchestrator/status/route');
    const request = new Request('http://localhost:3000/api/admin/orchestrator/status', {
      method: 'GET',
    });
