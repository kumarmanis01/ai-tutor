/**
 * UNIT TESTS: app/api/admin/content-approval
 *
...
describe('GET /api/admin/content-approval', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/content-approval/route');
    const request = new Request('http://localhost:3000/api/admin/content-approval', {
      method: 'GET',
    });
