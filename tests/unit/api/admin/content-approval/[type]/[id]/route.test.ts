/**
 * UNIT TESTS: app/api/admin/content-approval/[type]/[id]
 *
...
describe('GET /api/admin/content-approval/[type]/[id]', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/content-approval/[type]/[id]/route');
    const request = new Request('http://localhost:3000/api/admin/content-approval/[type]/[id]', {
      method: 'GET',
    });
