/**
 * UNIT TESTS: app/api/admin/chapters/[id]/approve
 *
...
describe('POST /api/admin/chapters/[id]/approve', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/chapters/[id]/approve/route');
    const request = new Request('http://localhost:3000/api/admin/chapters/[id]/approve', {
      method: 'POST',
      body: JSON.stringify({
