/**
 * UNIT TESTS: app/api/admin/chapters/[id]/reject
 *
...
describe('POST /api/admin/chapters/[id]/reject', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/chapters/[id]/reject/route');
    const request = new Request('http://localhost:3000/api/admin/chapters/[id]/reject', {
      method: 'POST',
      body: JSON.stringify({
