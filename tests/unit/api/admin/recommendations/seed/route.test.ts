/**
 * UNIT TESTS: app/api/admin/recommendations/seed
 *
...
describe('POST /api/admin/recommendations/seed', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/recommendations/seed/route');
    const request = new Request('http://localhost:3000/api/admin/recommendations/seed', {
      method: 'POST',
      body: JSON.stringify({
