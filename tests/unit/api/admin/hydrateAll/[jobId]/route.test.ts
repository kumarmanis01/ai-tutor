/**
 * UNIT TESTS: app/api/admin/hydrateAll/[jobId]
 *
 * Tests for HTTP methods: GET, DELETE
 */
...
describe('GET /api/admin/hydrateAll/[jobId]', () => {
  ...
  it('should return success response', async () => {
    ...
    const request = new Request('http://localhost:3000/api/admin/hydrateAll/[jobId]', {
      method: 'GET',
    });

    const response = await GET(request, { params: {
      "jobId": "mock-jobId-123"
} });
