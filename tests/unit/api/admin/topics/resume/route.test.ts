/**
 * UNIT TESTS: app/api/admin/topics/resume
 *
...
describe('POST /api/admin/topics/resume', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/topics/resume/route');
    const request = new Request('http://localhost:3000/api/admin/topics/resume', {
      method: 'POST',
      body: JSON.stringify({
