/**
 * UNIT TESTS: app/api/admin/topics/[id]/generate
 *
...
describe('POST /api/admin/topics/[id]/generate', () => {
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/topics/[id]/generate/route');
    const request = new Request('http://localhost:3000/api/admin/topics/[id]/generate', {
      method: 'POST',
      body: JSON.stringify({
