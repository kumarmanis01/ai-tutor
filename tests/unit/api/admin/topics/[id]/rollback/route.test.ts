/**
 * UNIT TESTS: app/api/admin/topics/[id]/rollback
 *
...
describe('POST /api/admin/topics/[id]/rollback', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/topics/[id]/rollback/route');
    const request = new Request('http://localhost:3000/api/admin/topics/[id]/rollback', {
      method: 'POST',
      body: JSON.stringify({
