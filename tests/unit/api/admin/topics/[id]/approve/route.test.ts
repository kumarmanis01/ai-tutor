/**
 * UNIT TESTS: app/api/admin/topics/[id]/approve
 *
...
describe('POST /api/admin/topics/[id]/approve', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/topics/[id]/approve/route');
    const request = new Request('http://localhost:3000/api/admin/topics/[id]/approve', {
      method: 'POST',
      body: JSON.stringify({
