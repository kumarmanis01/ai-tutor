/**
 * UNIT TESTS: app/api/admin/topics/pause
 *
...
describe('POST /api/admin/topics/pause', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/topics/pause/route');
    const request = new Request('http://localhost:3000/api/admin/topics/pause', {
      method: 'POST',
      body: JSON.stringify({
