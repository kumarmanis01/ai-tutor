/**
 * UNIT TESTS: app/api/admin/syllabi
 *
...
describe('GET /api/admin/syllabi', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/syllabi/route');
    const request = new Request('http://localhost:3000/api/admin/syllabi', {
      method: 'GET',
    });
