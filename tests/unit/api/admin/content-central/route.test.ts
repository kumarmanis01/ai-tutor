/**
 * UNIT TESTS: app/api/admin/content-central
 *
...
describe('GET /api/admin/content-central', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/content-central/route');
    const request = new Request('http://localhost:3000/api/admin/content-central', {
      method: 'GET',
    });
