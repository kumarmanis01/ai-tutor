/**
 * UNIT TESTS: app/api/admin/syllabus/[id]/approve
 *
...
describe('POST /api/admin/syllabus/[id]/approve', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/syllabus/[id]/approve/route');
    const request = new Request('http://localhost:3000/api/admin/syllabus/[id]/approve', {
      method: 'POST',
      body: JSON.stringify({
