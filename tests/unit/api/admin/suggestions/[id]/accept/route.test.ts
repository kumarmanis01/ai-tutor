/**
 * UNIT TESTS: app/api/admin/suggestions/[id]/accept
 *
...
describe('POST /api/admin/suggestions/[id]/accept', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/suggestions/[id]/accept/route');
    const request = new Request('http://localhost:3000/api/admin/suggestions/[id]/accept', {
      method: 'POST',
      body: JSON.stringify({
