/**
 * UNIT TESTS: app/api/admin/suggestions/[id]/dismiss
 *
...
describe('POST /api/admin/suggestions/[id]/dismiss', () => {
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/suggestions/[id]/dismiss/route');
    const request = new Request('http://localhost:3000/api/admin/suggestions/[id]/dismiss', {
      method: 'POST',
      body: JSON.stringify({
