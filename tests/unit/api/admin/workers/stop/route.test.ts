/**
 * UNIT TESTS: app/api/admin/workers/stop
 *
...
describe('POST /api/admin/workers/stop', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/workers/stop/route');
    const request = new Request('http://localhost:3000/api/admin/workers/stop', {
      method: 'POST',
      body: JSON.stringify({
