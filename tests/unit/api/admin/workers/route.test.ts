/**
 * UNIT TESTS: app/api/admin/workers
 *
...
describe('GET /api/admin/workers', () => {
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/workers/route');
    const request = new Request('http://localhost:3000/api/admin/workers', {
      method: 'GET',
    });
...
describe('POST /api/admin/workers', () => {
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/workers/route');
    const request = new Request('http://localhost:3000/api/admin/workers', {
      method: 'POST',
      body: JSON.stringify({
