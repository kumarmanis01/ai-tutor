/**
 * UNIT TESTS: app/api/admin/purge-auth
 *
...
describe('POST /api/admin/purge-auth', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/purge-auth/route');
    const request = new Request('http://localhost:3000/api/admin/purge-auth', {
      method: 'POST',
      body: JSON.stringify({
