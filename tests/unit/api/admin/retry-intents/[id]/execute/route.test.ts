/**
 * UNIT TESTS: app/api/admin/retry-intents/[id]/execute
 *
...
describe('POST /api/admin/retry-intents/[id]/execute', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/retry-intents/[id]/execute/route');
    const request = new Request('http://localhost:3000/api/admin/retry-intents/[id]/execute', {
      method: 'POST',
      body: JSON.stringify({
