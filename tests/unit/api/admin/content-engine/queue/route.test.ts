/**
 * UNIT TESTS: app/api/admin/content-engine/queue
 *
...
describe('GET /api/admin/content-engine/queue', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/content-engine/queue/route');
    const request = new Request('http://localhost:3000/api/admin/content-engine/queue', {
      method: 'GET',
    });
