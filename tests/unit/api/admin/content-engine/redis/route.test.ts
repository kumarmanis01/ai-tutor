/**
 * UNIT TESTS: app/api/admin/content-engine/redis
 *
...
describe('GET /api/admin/content-engine/redis', () => {
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/content-engine/redis/route');
    const request = new Request('http://localhost:3000/api/admin/content-engine/redis', {
      method: 'GET',
    });
