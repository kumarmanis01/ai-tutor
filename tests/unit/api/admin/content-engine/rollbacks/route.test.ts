/**
 * UNIT TESTS: app/api/admin/content-engine/rollbacks
 *
...
describe('GET /api/admin/content-engine/rollbacks', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/content-engine/rollbacks/route');
    const request = new Request('http://localhost:3000/api/admin/content-engine/rollbacks', {
      method: 'GET',
    });
