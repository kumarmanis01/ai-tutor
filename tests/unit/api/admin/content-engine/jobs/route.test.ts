/**
 * UNIT TESTS: app/api/admin/content-engine/jobs
 *
...
describe('POST /api/admin/content-engine/jobs', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/content-engine/jobs/route');
    const request = new Request('http://localhost:3000/api/admin/content-engine/jobs', {
      method: 'POST',
      body: JSON.stringify({
...
describe('GET /api/admin/content-engine/jobs', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/content-engine/jobs/route');
    const request = new Request('http://localhost:3000/api/admin/content-engine/jobs', {
      method: 'GET',
    });
