/**
 * UNIT TESTS: app/api/admin/content-engine/jobs/[id]
 *
...
describe('GET /api/admin/content-engine/jobs/[id]', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/content-engine/jobs/[id]/route');
    const request = new Request('http://localhost:3000/api/admin/content-engine/jobs/[id]', {
      method: 'GET',
    });
