/**
 * UNIT TESTS: app/api/admin/content-engine/jobs/tree
 *
...
describe('GET /api/admin/content-engine/jobs/tree', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/content-engine/jobs/tree/route');
    const request = new Request('http://localhost:3000/api/admin/content-engine/jobs/tree', {
      method: 'GET',
    });
