/**
 * UNIT TESTS: app/api/admin/content-engine/meta
 *
...
describe('GET /api/admin/content-engine/meta', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/content-engine/meta/route');
    const request = new Request('http://localhost:3000/api/admin/content-engine/meta', {
      method: 'GET',
    });
