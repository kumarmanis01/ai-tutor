/**
 * UNIT TESTS: app/api/admin/content-engine/moderation/[id]
 *
...
describe('GET /api/admin/content-engine/moderation/[id]', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/content-engine/moderation/[id]/route');
    const request = new Request('http://localhost:3000/api/admin/content-engine/moderation/[id]', {
      method: 'GET',
    });
