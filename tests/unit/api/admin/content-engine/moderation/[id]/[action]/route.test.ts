/**
 * UNIT TESTS: app/api/admin/content-engine/moderation/[id]/[action]
 *
...
describe('POST /api/admin/content-engine/moderation/[id]/[action]', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/content-engine/moderation/[id]/[action]/route');
    const request = new Request('http://localhost:3000/api/admin/content-engine/moderation/[id]/[action]', {
      method: 'POST',
      body: JSON.stringify({
