/**
 * UNIT TESTS: app/api/admin/content-engine/moderation
 *
...
describe('GET /api/admin/content-engine/moderation', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/content-engine/moderation/route');
    const request = new Request('http://localhost:3000/api/admin/content-engine/moderation', {
      method: 'GET',
    });
