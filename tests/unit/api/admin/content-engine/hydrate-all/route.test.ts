/**
 * UNIT TESTS: app/api/admin/content-engine/hydrate-all
 *
 * Tests for HTTP methods: POST, GET
 */
...
describe('POST /api/admin/content-engine/hydrate-all', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/admin/content-engine/hydrate-all/route');
    const request = new Request('http://localhost:3000/api/admin/content-engine/hydrate-all', {
      method: 'POST',
      body: JSON.stringify({
...
describe('GET /api/admin/content-engine/hydrate-all', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/content-engine/hydrate-all/route');
    const request = new Request('http://localhost:3000/api/admin/content-engine/hydrate-all', {
      method: 'GET',
    });
