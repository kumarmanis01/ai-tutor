/**
 * UNIT TESTS: app/api/admin/content-engine/audit-logs
 *
...
describe('GET /api/admin/content-engine/audit-logs', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/content-engine/audit-logs/route');
    const request = new Request('http://localhost:3000/api/admin/content-engine/audit-logs', {
      method: 'GET',
    });
