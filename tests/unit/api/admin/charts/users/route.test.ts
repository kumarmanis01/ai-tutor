/**
 * UNIT TESTS: app/api/admin/charts/users
 *
...
describe('GET /api/admin/charts/users', () => {
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/charts/users/route');
    const request = new Request('http://localhost:3000/api/admin/charts/users', {
      method: 'GET',
    });
