/**
 * UNIT TESTS: app/api/admin/charts/api-usage
 *
...
describe('GET /api/admin/charts/api-usage', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/admin/charts/api-usage/route');
    const request = new Request('http://localhost:3000/api/admin/charts/api-usage', {
      method: 'GET',
    });
