/**
 * UNIT TESTS: app/api/badges/share
 *
...
describe('POST /api/badges/share', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/badges/share/route');
    const request = new Request('http://localhost:3000/api/badges/share', {
      method: 'POST',
      body: JSON.stringify({
