...
describe('GET /api/classes/[id]', () => {
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/classes/[id]/route');
    const request = new Request('http://localhost:3000/api/classes/[id]', {
      method: 'GET',
    });
...
describe('PUT /api/classes/[id]', () => {
  ...
  it('should return success response', async () => {
    ...
    const { PUT } = await import('@/app/api/classes/[id]/route');
    const request = new Request('http://localhost:3000/api/classes/[id]', {
      method: 'PUT',
      body: JSON.stringify({
