...
describe('POST /api/save-chats', () => {
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/save-chats/route');
    const request = new Request('http://localhost:3000/api/save-chats', {
      method: 'POST',
      body: JSON.stringify({
