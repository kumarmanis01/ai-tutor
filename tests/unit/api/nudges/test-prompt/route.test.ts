/**
 * UNIT TESTS: app/api/nudges/test-prompt
 *
 * Tests for HTTP methods: GET, POST
 */
...
describe('GET /api/nudges/test-prompt', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/nudges/test-prompt/route');
    const request = new Request('http://localhost:3000/api/nudges/test-prompt', {
      method: 'GET',
    });
...
describe('POST /api/nudges/test-prompt', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/nudges/test-prompt/route');
    const request = new Request('http://localhost:3000/api/nudges/test-prompt', {
      method: 'POST',
      body: JSON.stringify({
