/**
 * UNIT TESTS: app/api/chapters/[id]
 *
...
describe('GET /api/chapters/[id]', () => {
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/chapters/[id]/route');
    const request = new Request('http://localhost:3000/api/chapters/[id]', {
      method: 'GET',
    });
...
describe('PUT /api/chapters/[id]', () => {
  ...
  it('should return success response', async () => {
    ...
    const { PUT } = await import('@/app/api/chapters/[id]/route');
    const request = new Request('http://localhost:3000/api/chapters/[id]', {
      method: 'PUT',
      body: JSON.stringify({
