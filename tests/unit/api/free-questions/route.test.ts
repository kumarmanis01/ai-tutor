/**
 * UNIT TESTS: app/api/free-questions
 *
...
describe('GET /api/free-questions', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const request = new Request('http://localhost:3000/api/free-questions', {
      method: 'GET',
    });
...
describe('POST /api/free-questions', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
