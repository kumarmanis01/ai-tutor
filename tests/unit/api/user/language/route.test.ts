/**
 * UNIT TESTS: app/api/user/language
 *
...
describe('GET /api/user/language', () => {
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/user/language/route');
    const request = new Request('http://localhost:3000/api/user/language', {
      method: 'GET',
    });
...
describe('POST /api/user/language', () => {
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/user/language/route');
    const request = new Request('http://localhost:3000/api/user/language', {
      method: 'POST',
      body: JSON.stringify({
