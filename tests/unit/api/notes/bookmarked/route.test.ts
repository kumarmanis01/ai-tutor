/**
 * UNIT TESTS: app/api/notes/bookmarked
 *
...
describe('GET /api/notes/bookmarked', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/notes/bookmarked/route');
    const request = new Request('http://localhost:3000/api/notes/bookmarked', {
      method: 'GET',
    });
