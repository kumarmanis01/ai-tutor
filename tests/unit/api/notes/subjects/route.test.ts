/**
 * UNIT TESTS: app/api/notes/subjects
 *
...
describe('GET /api/notes/subjects', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/notes/subjects/route');
    const request = new Request('http://localhost:3000/api/notes/subjects', {
      method: 'GET',
    });
