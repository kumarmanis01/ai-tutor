/**
 * UNIT TESTS: app/api/notes/downloaded
 *
...
describe('GET /api/notes/downloaded', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/notes/downloaded/route');
    const request = new Request('http://localhost:3000/api/notes/downloaded', {
      method: 'GET',
    });
