/**
 * UNIT TESTS: app/api/referral/create
 *
...
describe('POST /api/referral/create', () => {
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/referral/create/route');
    const request = new Request('http://localhost:3000/api/referral/create', {
      method: 'POST',
      body: JSON.stringify({
