/**
 * UNIT TESTS: app/api/referral/redeem
 *
...
describe('POST /api/referral/redeem', () => {
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/referral/redeem/route');
    const request = new Request('http://localhost:3000/api/referral/redeem', {
      method: 'POST',
      body: JSON.stringify({
