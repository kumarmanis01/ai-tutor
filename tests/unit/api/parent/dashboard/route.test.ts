/**
 * UNIT TESTS: app/api/parent/dashboard
 *
 * Tests for HTTP methods: GET, POST, DELETE
 */
...
describe('GET /api/parent/dashboard', () => {
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/parent/dashboard/route');
    const request = new Request('http://localhost:3000/api/parent/dashboard', {
      method: 'GET',
    });
...
describe('POST /api/parent/dashboard', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/parent/dashboard/route');
    const request = new Request('http://localhost:3000/api/parent/dashboard', {
      method: 'POST',
      body: JSON.stringify({
...
describe('DELETE /api/parent/dashboard', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { DELETE } = await import('@/app/api/parent/dashboard/route');
    const request = new Request('http://localhost:3000/api/parent/dashboard', {
      method: 'DELETE',
    });
