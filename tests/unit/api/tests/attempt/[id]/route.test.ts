/**
 * UNIT TESTS: app/api/tests/attempt/[id]
 *
...
describe('GET /api/tests/attempt/[id]', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/tests/attempt/[id]/route');
    const request = new Request('http://localhost:3000/api/tests/attempt/[id]', {
      method: 'GET',
    });
