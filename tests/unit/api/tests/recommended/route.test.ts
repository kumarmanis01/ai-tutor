/**
 * UNIT TESTS: app/api/tests/recommended
 *
...
describe('GET /api/tests/recommended', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/tests/recommended/route');
    const request = new Request('http://localhost:3000/api/tests/recommended', {
      method: 'GET',
    });
