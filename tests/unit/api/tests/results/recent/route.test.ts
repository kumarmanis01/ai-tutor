/**
 * UNIT TESTS: app/api/tests/results/recent
 *
...
describe('GET /api/tests/results/recent', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/tests/results/recent/route');
    const request = new Request('http://localhost:3000/api/tests/results/recent', {
      method: 'GET',
    });
