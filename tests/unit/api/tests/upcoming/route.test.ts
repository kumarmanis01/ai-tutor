/**
 * UNIT TESTS: app/api/tests/upcoming
 *
...
describe('GET /api/tests/upcoming', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/tests/upcoming/route');
    const request = new Request('http://localhost:3000/api/tests/upcoming', {
      method: 'GET',
    });
