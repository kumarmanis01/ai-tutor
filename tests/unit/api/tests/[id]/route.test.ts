...
describe('GET /api/tests/[id]', () => {
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/tests/[id]/route');
    const request = new Request('http://localhost:3000/api/tests/[id]', {
      method: 'GET',
    });
...
describe('PUT /api/tests/[id]', () => {
  ...
  it('should return success response', async () => {
    ...
    const { PUT } = await import('@/app/api/tests/[id]/route');
    const request = new Request('http://localhost:3000/api/tests/[id]', {
      method: 'PUT',
      body: JSON.stringify({
...
describe('DELETE /api/tests/[id]', () => {
  ...
  it('should return success response', async () => {
    ...
    const { DELETE } = await import('@/app/api/tests/[id]/route');
    const request = new Request('http://localhost:3000/api/tests/[id]', {
      method: 'DELETE',
    });
