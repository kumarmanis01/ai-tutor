/**
 * UNIT TESTS: app/api/chat/reassign-subject
 *
...
describe('POST /api/chat/reassign-subject', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/chat/reassign-subject/route');
    const request = new Request('http://localhost:3000/api/chat/reassign-subject', {
      method: 'POST',
      body: JSON.stringify({
