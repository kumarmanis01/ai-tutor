/**
 * UNIT TESTS: app/api/courses/[syllabusId]
 *
...
describe('GET /api/courses/[syllabusId]', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/courses/[syllabusId]/route');
    const request = new Request('http://localhost:3000/api/courses/[syllabusId]', {
      method: 'GET',
    });
