/**
 * UNIT TESTS: app/api/courses/[syllabusId]/[version]
 *
...
describe('GET /api/courses/[syllabusId]/[version]', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/courses/[syllabusId]/[version]/route');
    const request = new Request('http://localhost:3000/api/courses/[syllabusId]/[version]', {
      method: 'GET',
    });

    const response = await GET(request, { params: {
      "syllabusId": "mock-syllabusId-123",
      "version": "mock-version-123"
} });
