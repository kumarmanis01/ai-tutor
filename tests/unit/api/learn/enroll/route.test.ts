/**
 * UNIT TESTS: app/api/learn/enroll
 *
...
describe('POST /api/learn/enroll', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/learn/enroll/route');
    const request = new Request('http://localhost:3000/api/learn/enroll', {
      method: 'POST',
      body: JSON.stringify({
