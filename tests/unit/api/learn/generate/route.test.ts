/**
 * UNIT TESTS: app/api/learn/generate
 *
...
describe('POST /api/learn/generate', () => {
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/learn/generate/route');
    const request = new Request('http://localhost:3000/api/learn/generate', {
      method: 'POST',
      body: JSON.stringify({
...
describe('GET /api/learn/generate', () => {
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/learn/generate/route');
    const request = new Request('http://localhost:3000/api/learn/generate', {
      method: 'GET',
    });
