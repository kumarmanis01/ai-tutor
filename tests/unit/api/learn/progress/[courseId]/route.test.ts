/**
 * UNIT TESTS: app/api/learn/progress/[courseId]
 *
...
describe('GET /api/learn/progress/[courseId]', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/learn/progress/[courseId]/route');
    const request = new Request('http://localhost:3000/api/learn/progress/[courseId]', {
      method: 'GET',
    });
