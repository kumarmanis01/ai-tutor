/**
 * UNIT TESTS: app/api/learn/courses/[courseId]/lessons/[index]
 *
...
describe('GET /api/learn/courses/[courseId]/lessons/[index]', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/learn/courses/[courseId]/lessons/[index]/route');
    const request = new Request('http://localhost:3000/api/learn/courses/[courseId]/lessons/[index]', {
      method: 'GET',
    });

    const response = await GET(request, { params: {
      "courseId": "mock-courseId-123",
      "index": "mock-index-123"
} });
