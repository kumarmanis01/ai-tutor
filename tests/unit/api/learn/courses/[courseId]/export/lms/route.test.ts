/**
 * UNIT TESTS: app/api/learn/courses/[courseId]/export/lms
 *
...
describe('GET /api/learn/courses/[courseId]/export/lms', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/learn/courses/[courseId]/export/lms/route');
    const request = new Request('http://localhost:3000/api/learn/courses/[courseId]/export/lms', {
      method: 'GET',
    });
