/**
 * UNIT TESTS: app/api/learn/courses/[courseId]/export/pdf
 *
...
describe('GET /api/learn/courses/[courseId]/export/pdf', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/learn/courses/[courseId]/export/pdf/route');
    const request = new Request('http://localhost:3000/api/learn/courses/[courseId]/export/pdf', {
      method: 'GET',
    });
