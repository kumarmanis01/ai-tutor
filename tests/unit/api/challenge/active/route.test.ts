/**
 * UNIT TESTS: app/api/challenge/active
 *
...
describe('GET /api/challenge/active', () => {
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/challenge/active/route');
    const request = new Request('http://localhost:3000/api/challenge/active', {
      method: 'GET',
    });
