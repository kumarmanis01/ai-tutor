/**
 * UNIT TESTS: app/api/challenge/join
 *
...
describe('POST /api/challenge/join', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/challenge/join/route');
    const request = new Request('http://localhost:3000/api/challenge/join', {
      method: 'POST',
      body: JSON.stringify({
