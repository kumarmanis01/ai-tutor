/**
 * UNIT TESTS: app/api/msg91/widget-token
 *
...
describe('GET /api/msg91/widget-token', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { GET } = await import('@/app/api/msg91/widget-token/route');
    const request = new Request('http://localhost:3000/api/msg91/widget-token', {
      method: 'GET',
    });
