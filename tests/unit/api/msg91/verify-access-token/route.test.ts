/**
 * UNIT TESTS: app/api/msg91/verify-access-token
 *
...
describe('POST /api/msg91/verify-access-token', () => {
  beforeEach(() => {
    resetPrismaMock();
  });
  ...
  it('should return success response', async () => {
    ...
    const { POST } = await import('@/app/api/msg91/verify-access-token/route');
    const request = new Request('http://localhost:3000/api/msg91/verify-access-token', {
      method: 'POST',
      body: JSON.stringify({
