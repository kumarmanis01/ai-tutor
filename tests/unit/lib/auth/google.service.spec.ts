...
describe('lib/auth/google.service', () => {
  ...
  beforeEach(() => {
    ...
    verifyGoogleToken = (require('@/lib/auth/google.service') as typeof import('@/lib/auth/google.service')).verifyGoogleToken
  })
  ...
  describe('verifyGoogleToken', () => {
    ...
    it('should throw when GOOGLE_CLIENT_ID is not configured', async () => {
      ...
      const { verifyGoogleToken: fn } = require('@/lib/auth/google.service') as typeof import('@/lib/auth/google.service')
