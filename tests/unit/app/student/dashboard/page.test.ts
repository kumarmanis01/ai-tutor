...
jest.mock('@/components/student/dashboard/TodaysLearningCard', () => ({
  ...
  default: (props: any) =>
    React.createElement('div', { 'data-testid': 'TodaysLearningCard' }, JSON.stringify(props)),
}));
...
jest.mock('@/components/student/dashboard/SubjectReadinessCard', () => ({
  SubjectReadinessCard: () => React.createElement('div', { 'data-testid': 'SubjectReadinessCard' }),
}));
jest.mock('@/components/student/dashboard/FreemiumCounter', () => ({
  FreemiumCounter: () => React.createElement('div', { 'data-testid': 'FreemiumCounter' }),
}));
