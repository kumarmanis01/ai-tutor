  ...
  return (
    <PageWrapper step={3}>
      ...
      <p className="text-sm text-gray-500 dark:text-gray-400 mt-2 text-center">
        Vidya, your child&apos;s AI tutor, will start personalising lessons right away.
        You&apos;ll get a weekly progress report every Sunday.
      </p>
      <Link
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex items-start sm:items-center justify-center py-12 px-4">
      <div className="w-full max-w-md bg-white dark:bg-gray-900 rounded-3xl shadow-xl p-6 sm:p-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <span className="text-[#534AB7] font-extrabold text-lg tracking-tight">Spinzy Academy</span>
        </div>
            ...
            {STEPS.map((label, idx) => {
              ...
              return (
                <div key={label} className="flex items-center gap-2 flex-1 last:flex-none">
                  ...
                  <span className={`text-xs hidden sm:inline ${active ? 'text-[#534AB7] font-semibold' : 'text-gray-400'}`}>
                    {label}
                  </span>
                  {idx < STEPS.length - 1 && (
