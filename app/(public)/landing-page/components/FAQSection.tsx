...
const FAQSection = () => {
  ...
  const faqs: FAQ[] = [
    ...
    },
    {
      ...
      answerEn: `Yes! Start with our Free Plan (${FREE_SESSIONS_TEXT}) to test the app. No credit card required. When ready, upgrade to unlimited access for just ${PLANS.standard_monthly.perMonthDisplay}. Plus, we offer 30-day money-back guarantee on all paid plans.`,
      answerHi: `हां! ऐप का परीक्षण करने के लिए हमारी Free Plan (${FREE_SESSIONS_TEXT_HI}) से शुरू करें। कोई क्रेडिट कार्ड की आवश्यकता नहीं। तैयार होने पर, केवल ${PLANS.standard_monthly.perMonthDisplay} में असीमित एक्सेस में अपग्रेड करें। साथ ही, हम सभी paid plans पर 30-दिन की मनी-बैक गारंटी प्रदान करते हैं।`,
      category: 'Pricing',
    },
    {
      id: 6,
