/**
 * FILE OBJECTIVE:
 * - Block a platform user by setting accountStatus to 'suspended'.
 *
 * LINKED UNIT TEST:
 * - tests/unit/app/api/v1/admin/platform-users/[userId]/route.spec.ts
 *
 * EDIT LOG:
 * - 2026-05-03T00:00:00Z | claude | created block endpoint for platform user management
 */
