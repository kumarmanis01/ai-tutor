...
export async function POST(req: Request) {
  ...
  const grade = typeof b.grade === 'string' || typeof b.grade === 'number' ? String(b.grade) : undefined
  const board = typeof b.board === 'string' ? b.board : undefined
  const channel = b.channel === 'whatsapp' ? 'whatsapp' : b.channel === 'email' ? 'email' : undefined
  const parentContactRaw = typeof b.parent_contact === 'string' ? b.parent_contact.trim() : undefined
