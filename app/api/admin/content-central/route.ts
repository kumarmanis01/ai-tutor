    ...
    if (type === 'all' || type === 'chapter') {
      ...
      chapters.forEach((c) =>
        items.push({
          ...
          details: { subject: c.subject?.name },
    ...
    if (type === 'all' || type === 'topic') {
      ...
      topics.forEach((t) =>
        items.push({
          ...
          details: { chapterName: t.chapter?.name, subject: t.chapter?.subject?.name },
    ...
    if (type === 'all' || type === 'note') {
      ...
      notes.forEach((n) =>
        items.push({
          ...
          details: { topicId: n.topicId },
          metadata: { language: n.language, status: n.status },
        })
      );
    }
    ...
    if (type === 'all' || type === 'test') {
      ...
      tests.forEach((t) =>
        items.push({
          ...
          label: t.title || t.id,
          createdAt: t.createdAt,
          details: { topicId: t.topicId },
          metadata: { language: t.language, difficulty: t.difficulty, status: t.status },
        })
      );
    }
