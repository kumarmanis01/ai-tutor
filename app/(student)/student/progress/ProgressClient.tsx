...
import { AppHeader, BottomNav, Card, EmptyState, TierPill, SectionTitle, Ring, Bar, Segmented, SubjectChip, Mono } from '@/components/ui'
...
function SubjectProgressRow({ s }: { s: SubjectProgress }) {
  ...
  const pct = s.topicsTotal > 0 ? Math.round((s.topicsCompleted / s.topicsTotal) * 100) : 0
  return (
...
export default function ProgressClient({ initialData }: { initialData: ProgressData }) {
