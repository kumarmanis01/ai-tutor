...
import {
  BottomNav, Card, Btn, EmptyState, SectionTitle,
  Ring, TierPill, Bar, SubjectChip, Mono,
} from '@/components/ui'
...
export default function DashboardClient({ initialData }: { initialData: DashboardData }) {
  ...
  const freeLimit = data.freeLimit ?? FREE_TIER_SESSION_LIMIT
  const isFreemiumLocked = data.isFreemium && data.sessionsUsed >= freeLimit
            ...
            {isFreemiumLocked && (
              <div className="mb-4 rounded-[18px] p-4 [background:linear-gradient(135deg,var(--primary),oklch(0.4_0.2_270))] text-white">
                ...
                <div className="text-[13.5px] opacity-[0.92] leading-[1.45] mb-[14px]">
                  Free plan includes {freeLimit} Vidya sessions a day. Go Premium for unlimited learning.
                </div>
