...
import { AppHeader, BottomNav, Card, Btn, EmptyState, TierPill, Ring, Bar, Segmented, SubjectChip, Mono } from '@/components/ui'
  ...
  return (
    <Card pad={14} onClick={onView} className="flex items-center gap-3 cursor-pointer">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-[11.5px] text-[var(--text-faint)] mt-[3px]">+{t.xpEarned ?? 0} XP · {t.date}</div>
      </div>
...
export default function TestsClient({ initialData }: { initialData: TestsData }) {
  const router = useRouter()
