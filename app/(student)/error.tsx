/**
 * FILE OBJECTIVE:
 * - Route-segment error boundary for all student routes (/(student)/**).
 * - Catches errors within the student segment without blanking the entire app.
 ...
 *
 * EDIT LOG:
 * - 2026-05-18T00:00:00Z | claude | added student route-segment error boundary
 */
'use client';
...
export default function StudentError({ error: _error, reset }: ErrorProps) {
