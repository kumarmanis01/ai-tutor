...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto p-6">
      ...
      <p className="mb-4">
        By using AI Tutor, you agree to the following terms and conditions. Please read them
        carefully.
      </p>
      ...
      <p className="mb-4">
        All content, trademarks, and data on this site are the property of AI Tutor or its
        licensors.
      </p>
      <h2 className="text-xl font-semibold mt-6 mb-2">Limitation of Liability</h2>
      <p className="mb-4">
        AI Tutor is provided &quot;as is&quot; without warranties of any kind. We are not liable for
