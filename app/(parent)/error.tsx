/**
 * FILE OBJECTIVE:
 * - Route-segment error boundary for all parent routes (/(parent)/**).
 * - Catches errors within the parent segment without blanking the entire app.
 ...
 *
 * EDIT LOG:
 * - 2026-05-18T00:00:00Z | claude | added parent route-segment error boundary
 */
'use client';
