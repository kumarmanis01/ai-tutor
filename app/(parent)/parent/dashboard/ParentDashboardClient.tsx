...
export default function ParentDashboardClient({ initialData }: { initialData: ParentDashboardData | null }) {
    ...
    return (
      <div className="bg-[var(--bg)] min-h-screen max-w-[390px] mx-auto">
        ...
        <EmptyState
          ...
          body="Link your child to start seeing their progress here."
          action="Link child"
          onAction={() => router.push('/parent/onboarding')}
        />
      </div>
    )
  }
