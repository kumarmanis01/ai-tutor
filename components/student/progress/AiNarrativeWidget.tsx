            ...
            try {
              ...
              if (!res.ok) {
                ...
                void fetch('/api/analytics/track', {
                  ...
                  body: JSON.stringify({
                    event: 'export_progress_pdf',
                    data: { success: false, reason: `status_${res.status}` },
                  }),
                }).catch(() => {});
                return;
              }
              ...
              void fetch('/api/analytics/track', {
                ...
                body: JSON.stringify({
                  event: 'export_progress_pdf',
                  data: { success: true, fileSize: (blob && (blob as any).size) ?? null },
                }),
              }).catch(() => {});
            } catch (err) {
              ...
              void fetch('/api/analytics/track', {
                ...
                body: JSON.stringify({
                  event: 'export_progress_pdf',
                  data: { success: false, reason: 'network_error' },
                }),
