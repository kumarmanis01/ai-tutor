 ...
 * - 2026-05-17 | reviewer | replace emoji with lucide icons; widen to max-w-5xl;
 *                           add two-column layout at md+
 */
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-6">
      <div className="grid grid-cols-1 md:grid-cols-[3fr_2fr] gap-6">
        {/* Left: homework card + buttons */}
        <div className="space-y-5">
          <div className="text-center">
            <div className="flex justify-center">
              <BookOpen className="w-10 h-10 text-[#534AB7]" strokeWidth={1.5} aria-hidden />
            </div>
